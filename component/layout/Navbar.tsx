...
function Dropdown({
  ...
  return (
    <li className="relative group list-none w-full lg:w-auto">
      ...
      {/* Desktop Dropdown */}
      <ul className="hidden lg:block absolute left-0 top-full pt-2 w-56 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 ease-out scale-95 group-hover:scale-100 z-50">
      ...
      <nav className="max-w-7xl mx-auto flex items-center justify-between px-4 lg:px-8 py-4">
        ...
        >
          <ul className="flex flex-col lg:flex-row w-full items-start lg:items-center gap-2 lg:gap-5 xl:gap-7">
            ...
            <Dropdown title="Business Division">
